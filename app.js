...
button.addEventListener('click', ()=> {
    ...
    const answer1 = prompt("Is the Elephant's Foot comprised of a material called Corium?");
    ...
    const answer3 = prompt("Is the Elephant's foot the only known instance of Corium on the earth?");
